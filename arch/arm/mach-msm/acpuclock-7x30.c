...
static struct clkctl_acpu_speed acpu_freq_tbl[] = {
	...
	{ 0, 1900800, PLL_2, 3, 0, UINT_MAX, 1475, VDD_RAW(1450), &pll2_tbl[11]},
	// DooMLoRD:[ END ]: added some frequencies
	{ 0 }
};
